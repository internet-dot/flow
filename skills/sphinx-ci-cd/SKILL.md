---
name: sphinx-ci-cd
description: Automated documentation lifecycles inside GitHub Actions pipelines, integrating dynamic asset generation (like VHS terminal recordings) and builds leveraging modern tooling. Use when setting up or debugging automated compilation workflows for docs.
---
