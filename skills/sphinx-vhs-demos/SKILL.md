---
name: sphinx-vhs-demos
description: Creating reproducible, automated terminal recordings (GIFs or videos) using Charmbracelet's VHS for inclusion in documentation. Use this when building guides demonstrating command-line tools and interfaces.
---
