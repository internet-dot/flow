---
name: sphinx-wasm-playground
description: Implementing interactive WebAssembly-powered code playgrounds (like Pyodide) embedded directly inside Sphinx documentation. Use when building guides that benefit from live sandbox execution.
---
